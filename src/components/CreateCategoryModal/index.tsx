          ...
          <div className="bg-gray-900 p-6 rounded-lg shadow-md w-full max-w-sm border border-gray-700">
            ...
            <div className="flex flex-col">
              <input
                ...
                required
                className="w-full bg-transparent border-b border-gray-600 focus:border-blue-500 text-white p-2 mb-6 outline-none placeholder-gray-400"
              />
              ...
              <div className="flex justify-end gap-2">
                <button
                  ...
                  className="text-sm px-4 py-1 text-gray-300 cursor-pointer hover:text-white"
                >
                  Cancelar
                </button>
                <button
                  ...
                  className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-1.5 rounded text-sm cursor-pointer"
                >
                  Criar
                </button>
              </div>
